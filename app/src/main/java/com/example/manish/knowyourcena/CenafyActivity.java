...
public class CenafyActivity extends AppCompatActivity {
    final MediaPlayer mp = new MediaPlayer();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cenafy);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_cenafy, menu);
        return true;
    }
    ...
    public void processsSentance(View view) throws IOException {
        ...
        if(def.equals(""))
        {
            ...
            Toast.makeText(CenafyActivity.this,
